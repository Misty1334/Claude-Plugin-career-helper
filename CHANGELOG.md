...
- Getting-started guides updated for fourteen skills: `full-overview.md` (new skill section with examples and the automation paragraph), `skill-tips.md` (tips for the new skill), `getting-the-best-guide.md` (table row and skill count, PDF regenerated), `power-user-strategies.md` (routine list), `workflow-planner.md` (new intake option and Pattern I: Employed and Quietly Exploring), `preparation-checklist.md` (new scenario), and the getting-started skill itself (routine list, counts, related skills, v1.14.0)
